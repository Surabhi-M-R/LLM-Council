...
from .openrouter import query_models_parallel, query_model, truncate_to_token_budget, estimate_tokens, get_max_input_tokens
from .config import COUNCIL_MODELS, CHAIRMAN_MODEL, MAX_RESPONSE_CHARS, MAX_RANKING_CHARS
...
Provide a clear, well-reasoned final answer that represents the council's collective wisdom:"""
    ...
    if response is None:
        return {
            "model": CHAIRMAN_MODEL,
            "response": "Error: Unable to generate final synthesis.",
            "error": "The chairman model request failed. Check your OpenRouter key or quota."
        }
